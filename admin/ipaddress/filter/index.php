...
if (strlen($sGlobalSearch))
{
	...
	is_numeric($sGlobalSearch) && $oAdmin_Form_Dataset
			->addCondition(array('where' => array('ipaddress_filter_dirs.id', '=', intval($sGlobalSearch))))
	...
	Core_Event::notify('Ipaddress_Filter_GlobalSearch.onAfterSetConditions', NULL, array($oAdmin_Form_Dataset, $sGlobalSearch));
}
else
{
...
if (strlen($sGlobalSearch))
{
	...
	is_numeric($sGlobalSearch) && $oAdmin_Form_Dataset
			->addCondition(array('where' => array('ipaddress_filters.id', '=', intval($sGlobalSearch))))
			->addCondition(array('setOr' => array()));
