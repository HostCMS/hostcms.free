 ...
 */
class Event_Controller_Timeline extends Crm_Timeline_Controller
{
	/**
	 * Constructor
	...
	public function __construct($oAdmin_Form_Controller)
	{
		...
		$this->_formPath = '/{admin}/event/timeline/index.php';
		$this->_notePath = '/{admin}/event/note/index.php';
	...
	public function getCompletedDropdown()
	{
		...
		return $oEventParent->getCompletedDropdown($this->_Admin_Form_Controller);
	}
}