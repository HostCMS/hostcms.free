...
/**
 * Wysiwyg_Driver_Tinymce6_Handler.
 *
 * @package HostCMS
 * @subpackage Wysiwyg
 * @version 7.x
 ...
 */
class Wysiwyg_Driver_Tinymce6_Handler extends Wysiwyg_Handler
{
	/**
	 * Base path
	 * @var string
	 */
	static protected $_basePath = '/modules/wysiwyg/driver/tinymce6';
	...
	{
		return Core_Config::instance()->get('wysiwyg_tinymce6', array());
	}
