 ...
 */
// MS Word filtering logic for TinyMCE 6.x from Paste Plugin 5.10.2
// https://github.com/tinymce/tinymce/discussions/7487
// https://github.com/tinymce/tinymce/blob/5.10.2/modules/tinymce/src/plugins/paste/main/ts/core/WordFilter.ts

/* Yes. The paste plugin was integrated into core with TinyMCE 6. As I described, it should be possible to reduce the TinyMCE 5 paste plugin to just the MS Word filtering logic and build a plugin on that (this is similar to how our premium PowerPaste plugin operates). Something along the lines of:

  editor.on('paste', (e) => {
    if (pastingFromMSWord(e)) {
      handlePaste(e);
      e.preventDefault();
    }
  });
...
(function () {
    ...
    var innerText = function (html) {
	  ...
	  console.log(shortEndedElements);
    ...
    var pasteText = function (editor, text) {
      ...
      var html = convert(encodedText, getForcedRootBlock(editor), getForcedRootBlockAttrs(editor));
    ...
    var registerEventHandlers = function (editor, pasteBin, pasteFormat) {
      ...
      editor.on('keydown', function (e) {
		...
		// Работаем только если Word-содержимое
