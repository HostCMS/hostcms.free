...
class Shop_Warehouse_Inventory_Item_Controller_Delete extends Admin_Form_Action_Controller
{
	...
	public function execute($operation = NULL)
	{
		...
		if (!is_null($oShop_Warehouse_Inventory_Item))
		{
			...
			$aShop_Warehouse_Entries = $oShop_Warehouse->Shop_Warehouse_Entries->getByDocumentAndShopItem($oShop_Warehouse_Inventory->id, $oShop_Warehouse_Inventory::TYPE, $shop_item_id);
