...
class Shop_Warehouse_Writeoff_Item_Controller_Delete extends Admin_Form_Action_Controller
{
	...
	public function execute($operation = NULL)
	{
		...
		{	
			...
			$aShop_Warehouse_Entries = $oShop_Warehouse->Shop_Warehouse_Entries->getByDocumentAndShopItem($oShop_Warehouse_Writeoff->id, $oShop_Warehouse_Writeoff::TYPE, $shop_item_id);
