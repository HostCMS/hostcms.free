...
return array(
	...
	'yandex_market_bid' => 'Яндекс.Маркет - основная расценка',
	'yandex_market_cid' => 'Яндекс.Маркет - расценка для карточек моделей',
	...
	'delete_associated_items' => 'Удалять существующие сопутствующие товары',
	...
	'shop_gift_show_title' => 'Подарки',

	'flag_include_shortcut_parent_item' => 'Применить к основным товарам ярлыков',
	'change_price_main_header' => 'Основные',
	'change_price_discount_header' => 'Скидка',
	'change_price_bonus_header' => 'Бонус',

	'aiApply_success' => 'AI-интеграция применена успешно!',
	'ai_prompt_description' => 'Напиши привлекающее краткое описание товара "%1$s" от производителя "%2$s" для продажи в интернет-магазине, не используй эмодзи. В ответе предоставь только значение описания, длина не более 500 символов',
	'ai_prompt_text' => 'Напиши привлекающее описание товара "%1$s" от производителя "%2$s" для продажи в интернет-магазине, не используй эмодзи. Используй HTML-разметку, списки и таблицы, если есть сведения о технических характеристиках, то укажи и их тоже. В ответе предоставь только значение описания, длина не более 5000 символов',
	'item_edit_warehouse_limit' => 'Превышен лимит показа складов в карточке товара. Управляйте остатками через <a target="_blank" href="%s">склады</a>.',
);