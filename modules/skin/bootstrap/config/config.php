...
return array (
	'adminMenu' => array(
		...
		'crm' => array(
			...
			'modules' => array('lead', 'siteuser', 'crm_project', 'deal', 'event', 'user', 'calendar', 'messenger', 'company'),
		),
		'tools' => array(
			'ico' => 'fa fa-briefcase',
		...
		'system' => array(
			...
			'modules' => array('site', 'eventlog', 'notification', 'field', 'benchmark', 'admin_form', 'module', 'constant', 'restapi', 'webhook', 'ipaddress'),
		),
		'cache' => array(
			'ico' => 'fa fa-archive',
