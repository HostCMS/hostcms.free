...
return array(
	...
	'ai_prompt_description' => 'Напиши краткое описание статьи для раздела "%1$s" про "%2$s" для размещения на сайте, не используй эмодзи. Используй HTML-разметку, списки и таблицы. В ответе предоставь только значение описания, длина не более 500 символов',
	'ai_prompt_text' => 'Напиши текст статьи для раздела "%1$s" про "%2$s" для размещения на сайте, не используй эмодзи. Используй HTML-разметку, списки и таблицы. В ответе предоставь только значение описания, длина не более 5000 символов',
);