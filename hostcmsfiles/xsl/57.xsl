		...
		<xsl:choose>
			...
			<xsl:otherwise>
				...
				<form action="{/shop/url}cart/" method="post">
					...
					<div class="delivery-time" style="margin-bottom: 10px;">
						<input id="datepicker_cart_time_from" type="text" name="time_from"/>
						<input id="datepicker_cart_time_to" type="text" name="time_to"/>
					</div>
