...
<!DOCTYPE xsl:stylesheet SYSTEM "lang://176">
					...
					<div class="description_sell">
						...
						<div class="price">
							...
							<!-- Ссылку на добавление в корзины выводим, если:
								...
								<!-- Избранное -->
								<div class="favorite" onclick="return $.addFavorite('{/shop/url}favorite/', {@id}, this)">
