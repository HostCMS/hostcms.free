																		...
																		<td valign="top" align="left">
																			...
																			<div>
																				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 16px;line-height:22px; color:#808285;">
																					В магазине "<xsl:value-of select="/shop/name"/>"
																				</span>
																			</div>
																			<div>
																				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 20px;line-height:24px; color:#606163;"><b>был оформлен заказ № <xsl:value-of select="shop_order/invoice" /></b></span>
																			</div>
