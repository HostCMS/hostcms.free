...
class Shop_Payment_System_Handler13 extends Shop_Payment_System_Handler
{
	...
	*/
	...
	Перечисление со значениями:
		...
		7 => Vat5 - Ставка НДС 5%;
		8 => Vat7 - Ставка НДС 7%;
		9 => Vat105 - НДС расч. 5/105;
		10 => Vat107 - Ставка НДС расч. 7/107
	*/
	protected $default_vat = 6;

	/* Массив отношений ставки налога в заказе и названия налога (none, vat0, vat110 или vat120)*/
	protected $vat = array(
		0 => 6, // None - НДС не облагается;
		5 => 9, // Vat105 - НДС расч. 5/105;
		7 => 10, // Vat107 - Ставка НДС расч. 7/107
		10 => 4, // Vat110 - Ставка НДС расч. 10/110;
		20 => 3, // Vat120 - Ставка НДС расч. 20/120;
	);
